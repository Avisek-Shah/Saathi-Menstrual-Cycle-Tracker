...
| 7    | Notification text never names period/app              | DONE (copy only)              | en.ts: "Reminder" / "Something's coming" / "Your window" — no cycle terms; scheduling service not built yet | yes — edit en.ts             |
